...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
	...
	Laravel
		...
		<div><br> has wonderful documentation covering every aspect of the framework. Whether you are a newcomer or have prior experience with	Laravel
	</div><a href="../public/submit"><font color="red"><h2>Replace links</h2></font></a>
		<div><br>, we recommend reading our documentation from beginning to end.
                                </p>
                            </div>
		...
		<div><br>, PHP, and JavaScript development. Check them out, see for yourself, and massively level up your development skills in the process.
                                </p>
                            </div>
	...
	Laravel
		...
		<div><br> News is a community driven portal and newsletter aggregating all of the latest and most important news in the	Laravel
	</div><a href="../public/submit"><font color="red"><h2>Replace links</h2></font></a>
		<div><br> ecosystem, including new package releases and tutorials.
                                </p>
                            </div>
	...
	Laravel
		...
		<div><br> v<?php echo e(Illuminate\Foundation\Application::VERSION); ?> (PHP v<?php echo e(PHP_VERSION); ?>)
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /var/www/webroot/ROOT/Qrcodes/resources/views/welcome.blade.php ENDPATH**/ ?>